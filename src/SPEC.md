...
| `connection/`  | 7, 23    | Connection Handler + Connection Manager — per-connection lifecycle helpers and dedicated listener/thread lifecycle management extracted from `Broker`. |
