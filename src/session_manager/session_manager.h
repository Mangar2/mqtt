 ...
 * @brief SessionManager — top-level session lifecycle coordinator (Module 10.1).
 */
...
private:
    /// Remove all data associated with a session (subscriptions + inflight + session record).
