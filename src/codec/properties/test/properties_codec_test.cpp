...
TEST_CASE("props_encode_not_allowed", "[properties]")
{
    ...
    std::vector<Property> props{
        {PropertyId::TopicAlias, TwoByteInteger{1U}}
    };
    try {
        encode_properties(buf, props, PacketType::Connect);
        FAIL("Expected CodecException");
...
TEST_CASE("props_encode_duplicate", "[properties]")
{
    WriteBuffer buf;
    std::vector<Property> props{
        {PropertyId::PayloadFormatIndicator, uint8_t{0}},
        {PropertyId::PayloadFormatIndicator, uint8_t{1}}
    };
    try {
        encode_properties(buf, props, PacketType::Publish);
...
TEST_CASE("props_encode_user_prop_repeat", "[properties]")
{
    WriteBuffer buf;
    std::vector<Property> props{
        {PropertyId::UserProperty, Utf8StringPair{Utf8String{"k1"}, Utf8String{"v1"}}},
        {PropertyId::UserProperty, Utf8StringPair{Utf8String{"k2"}, Utf8String{"v2"}}}
    };
...
TEST_CASE("props_decode_user_prop_repeat", "[properties]")
{
    WriteBuffer buf;
    std::vector<Property> props{
        {PropertyId::UserProperty, Utf8StringPair{Utf8String{"a"}, Utf8String{"1"}}},
        {PropertyId::UserProperty, Utf8StringPair{Utf8String{"b"}, Utf8String{"2"}}}
    };
    encode_properties(buf, props, PacketType::Publish);
...
TEST_CASE("props_roundtrip", "[properties]")
{
    std::vector<Property> original{
        ...
        {PropertyId::UserProperty,            Utf8StringPair{Utf8String{"key"}, Utf8String{"value"}}}
    };
