                                       ...
                                       PropertyDataType expected) noexcept
{
    switch (expected) {
        ...
        case PropertyDataType::FourByteInteger:     return std::holds_alternative<FourByteInteger>(value);
        case PropertyDataType::VariableByteInteger: return std::holds_alternative<VariableByteInteger>(value);
        case PropertyDataType::Utf8String:          return std::holds_alternative<Utf8String>(value);
        case PropertyDataType::Utf8StringPair:      return std::holds_alternative<Utf8StringPair>(value);
        case PropertyDataType::BinaryData:          return std::holds_alternative<BinaryData>(value);
    }
...
{
    switch (byte) {
        case 0x01U: return PropertyId::PayloadFormatIndicator;
        case 0x02U: return PropertyId::MessageExpiryInterval;
        case 0x03U: return PropertyId::ContentType;
        case 0x08U: return PropertyId::ResponseTopic;
        case 0x09U: return PropertyId::CorrelationData;
        case 0x0BU: return PropertyId::SubscriptionIdentifier;
        case 0x11U: return PropertyId::SessionExpiryInterval;
        case 0x12U: return PropertyId::AssignedClientIdentifier;
        case 0x13U: return PropertyId::ServerKeepAlive;
        case 0x15U: return PropertyId::AuthenticationMethod;
        case 0x16U: return PropertyId::AuthenticationData;
        case 0x17U: return PropertyId::RequestProblemInformation;
        case 0x18U: return PropertyId::WillDelayInterval;
        case 0x19U: return PropertyId::RequestResponseInformation;
        case 0x1AU: return PropertyId::ResponseInformation;
        case 0x1CU: return PropertyId::ServerReference;
        case 0x1FU: return PropertyId::ReasonString;
        case 0x21U: return PropertyId::ReceiveMaximum;
        case 0x22U: return PropertyId::TopicAliasMaximum;
        case 0x23U: return PropertyId::TopicAlias;
        case 0x24U: return PropertyId::MaximumQoS;
        case 0x25U: return PropertyId::RetainAvailable;
        case 0x26U: return PropertyId::UserProperty;
        case 0x27U: return PropertyId::MaximumPacketSize;
        case 0x28U: return PropertyId::WildcardSubscriptionAvailable;
        case 0x29U: return PropertyId::SubscriptionIdentifierAvailable;
        case 0x2AU: return PropertyId::SharedSubscriptionAvailable;
        default:
...
[[nodiscard]] PropertyValue decode_property_value(ReadBuffer& buf, PropertyId id)
{
...
[[nodiscard]] bool is_seen(const std::vector<PropertyId>& seen, PropertyId id) noexcept
{
                       ...
                       PacketType context)
{
    ...
    for (const auto& prop : props) {
        ...
        if (!value_type_matches(prop.value, property_data_type(prop.id))) {
            throw CodecException{CodecError::PropertyTypeMismatch,
    ...
    encode_variable_byte_integer(buf, VariableByteInteger{static_cast<uint32_t>(temp.size())});
