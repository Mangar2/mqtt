...
| `value_service_runtime_config_rejects_invalid_filestore_retry_interval` | filestore startup retry interval range validation | ini with `filestore.startupRetryIntervalSeconds=0` | load fails with field-specific error |
