...
| `serial_device/` | serialdevice phase 1 | SerialDevice domain contract and deterministic subscription derivation based on legacy interface maps including receiver-map fallback quirks and `$SYS/serialdevice/#` system subscription. |
