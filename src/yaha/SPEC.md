...
| `serial_device_client/` | serialdevice phase 1 | Standalone SerialDevice INI mapping and runtime config types with deterministic fallback warnings for recoverable parse errors. |
