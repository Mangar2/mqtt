...
| `serial_device_client/` | serialdevice phase 5 | Standalone SerialDevice INI mapping and runtime config types with deterministic fallback warnings for recoverable parse errors, plus runtime composition wiring for SerialDevice component, serial transport, MQTT client, and signal-driven runtime wrapper. |
