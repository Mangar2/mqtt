...
| `rs485_interface_component_does_not_log_when_disabled` | Logging stays silent by default | default config (`logIncomingMessages=false`, `logOutgoingMessages=false`), `handleMessage` called | stdout contains no `rs485_interface` log line |
