...
struct MessageTreeConfig {
    ...
    static constexpr std::uint32_t k_default_upper_bound_add_in_milliseconds{2000U};
    static constexpr double k_default_lower_bound_factor{0.8};
    static constexpr std::uint32_t k_default_lower_bound_sub_in_milliseconds{2000U};
