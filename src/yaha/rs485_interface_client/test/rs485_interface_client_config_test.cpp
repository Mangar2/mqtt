...
bool loadRuntimeConfigFromIniText(const std::string &iniText,
...
[[nodiscard]] yaha::Rs485InterfaceRuntimeConfig loadValidRuntimeConfig() {
  ...
  std::string errorMessage{};
  REQUIRE(loadRuntimeConfigFromIniText(validRuntimeIniText(), runtimeConfig,
                                       errorMessage));
  REQUIRE(errorMessage.empty());
  return runtimeConfig;
}

TEST_CASE("rs485_runtime_config_parses_rs485_core_transport_fields",
          "[rs485_interface]") {
...
TEST_CASE("rs485_runtime_config_parses_rs485_behavior_fields",
          "[rs485_interface]") {
  const auto runtimeConfig = loadValidRuntimeConfig();
...
TEST_CASE("rs485_runtime_config_parses_mqtt_connection_fields",
          "[rs485_interface]") {
  const auto runtimeConfig = loadValidRuntimeConfig();
...
TEST_CASE("rs485_runtime_config_parses_interfaces_and_value_map",
  ...
  REQUIRE(runtimeConfig.rs485Config.interfaces.at("LightOnOff").usedBy.size() ==
          1U);
  REQUIRE(
      runtimeConfig.rs485Config.interfaces.at("LightOnOff").usedBy.front() ==
      'V');
  REQUIRE(runtimeConfig.rs485Config.interfaces.at("LightOnOff").map.at("on") ==
          3600U);
  REQUIRE(runtimeConfig.rs485Config.interfaces.at("LightOnOff").map.at("off") ==
          0U);
}

TEST_CASE("rs485_runtime_config_parses_command_address_and_topic_sections",
          "[rs485_interface]") {
  const auto runtimeConfig = loadValidRuntimeConfig();
  ...
  REQUIRE(runtimeConfig.rs485Config.topics.at("my/floor/device/switch/s1")
              .command == 'X');
  REQUIRE(
      runtimeConfig.rs485Config.topics.at("my/floor/device/switch/s1").value ==
      1U);
  REQUIRE(runtimeConfig.rs485Config.topics.at("my/floor/device/switch/s1")
              .address == 20U);
}

TEST_CASE("rs485_runtime_config_rejects_missing_serial_port",
          "[rs485_interface]") {
  ...
  REQUIRE_FALSE(
      loadRuntimeConfigFromIniText(iniText, runtimeConfig, errorMessage));
  REQUIRE(errorMessage.find("rs485interface.serialPortName") !=
          std::string::npos);
}

TEST_CASE("rs485_runtime_config_falls_back_on_invalid_trace_value",
          "[rs485_interface]") {
  const std::string iniText = "[mqtt]\n"
                              "host=127.0.0.1\n"
                              "\n"
...
TEST_CASE(
    "rs485_runtime_config_falls_back_on_missing_required_interfaces_section",
    "[rs485_interface]") {
  const std::string iniText = "[mqtt]\n"
                              "host=127.0.0.1\n"
                              "\n"
  ...
  REQUIRE(runtimeConfig.rs485Config.interfaces.empty());
    ...
    TEST_CASE("rs485_runtime_config_rejects_invalid_interface_keys",
              "[rs485_interface]") {
      const std::string iniText = "[mqtt]\n"
                                  "host=127.0.0.1\n"
                                  "\n"
...
TEST_CASE("rs485_runtime_config_falls_back_on_invalid_interface_map_value",
          "[rs485_interface]") {
  const std::string iniText = "[mqtt]\n"
                              "host=127.0.0.1\n"
                              "\n"
...
TEST_CASE("rs485_runtime_config_falls_back_on_missing_required_command_map_sections",
          "[rs485_interface]") {
  const std::string iniText = "[mqtt]\n"
                              "host=127.0.0.1\n"
                              "\n"
  ...
  REQUIRE(errorMessage.empty());
  REQUIRE(runtimeConfig.rs485Config.settings.empty());
  REQUIRE(runtimeConfig.rs485Config.status.empty());
}

TEST_CASE("rs485_runtime_config_falls_back_on_empty_topic_key_and_invalid_addresses",
          "[rs485_interface]") {
  const std::string iniText = "[mqtt]\n"
                              "host=127.0.0.1\n"
                              "\n"
...
TEST_CASE(
    "rs485_runtime_config_falls_back_on_invalid_command_keys_and_topics_values",
    "[rs485_interface]") {
  {
    const std::string iniText = "[mqtt]\n"
                                "host=127.0.0.1\n"
...
// NOLINTNEXTLINE(readability-function-cognitive-complexity)
TEST_CASE("rs485_runtime_config_falls_back_on_invalid_interface_segment_shapes",
          "[rs485_interface]") {
  {
    const std::string iniText = "[mqtt]\n"
                                "host=127.0.0.1\n"
