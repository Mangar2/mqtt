...
| `publish_v1_request_logs_outbound_message` | Publish builder emits outbound broker log line | call `publish("1.0", ...)` | stdout contains the outbound publish log line with version, qos, retain, packetid, and payload details |
